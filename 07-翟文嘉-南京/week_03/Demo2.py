...
class TorchModel(nn.Module):
    def __init__(self, input_dim, sentence_length, vocab):
        ...
        self.loss = nn.functional.binary_cross_entropy  #loss采用二分类交叉熵
    ...
    def forward(self, x, y=None):
        ...
        if y is not None:
            return self.loss(y_pred.squeeze(), y.squeeze().to(torch.float32))
        else:
            return y_pred
...
if __name__ == "__main__":
    main()
    test_strings = ["auvxe1", "yrw8rg", "rtw3qg", "nlhdww"]
