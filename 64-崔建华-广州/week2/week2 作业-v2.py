...
def build_sample(vocab, sentence_length):
    ...
    #A类样本
    if set("cui") & set(x) and not set("jhg") & set(x):
        y = 0
    #B类样本
    elif not set("cui") & set(x) and set("jhg") & set(x):
        y = 1
    #C类样本
    else:
        y = 2
...
if __name__ == "__main__":
    main()
    test_strings = ["reference", "restrictt", "reckontui", "deemedeen","avenueeee"]
