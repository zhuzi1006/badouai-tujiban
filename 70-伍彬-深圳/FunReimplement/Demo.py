...
# Windows7下的torch版本存在loss.backward()无法终止的问题
# 添加下两行代码后可以退出进程
# https://github.com/pytorch/pytorch/issues/48888
# https://github.com/pytorch/pytorch/pull/53170/commits/1b193eff830ffcafda9e5a507307e26d50917dc3
import os
...
def main():
    ...
    for epoch in range(epoch_num):
        ...
        for batch in range(int(train_sample / batch_size)):
            ...
            print("e:{}.b:{} Finished".format(epoch, batch))
